const cardss = [
  {
    name: "Aya",
    paragraph:
      " The moment you start believing in yourself, you’ve already won half the battle.",
    image: "777.png",
  },
  {
    name: "Seif",
    paragraph:
      "Aim for the impossible and don’t stop until you’ve made it possible.",
    image: "888.png",
  },
  {
    name: "Hana",
    paragraph:
      "The more you invest in your dreams, the more rewarding the harvest will be.",
    image: "999.png",
  },
];
...
for (const card of cardss) {
  ...
  //استخدام createtextnode (بتشتغل على document)
  let text = document.createTextNode(card.paragraph);
